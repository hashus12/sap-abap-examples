...
*----------------------------------------------------------------------*
FORM set_layout .
  gs_layout-window_titlebar   = 'REUSE ALV EĞİTİM VİDEOSU SERİSİ'.
  gs_layout-zebra             = abap_true.
  gs_layout-colwidth_optimize = abap_true.
  gs_layout-box_fieldname     = 'SELKZ'.     "Satır seçimi ni yönetmesi için kullandık.
  gs_layout-info_fieldname    = 'LINE_COLOR'. "alv de kullandığım line color alanı satır renklendirmesi için kullanacağım alan demek oldu.,
